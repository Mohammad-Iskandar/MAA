...
,
        ...
        {
            title: "تطورات الواقع الافتراضي",
            content: "آبل تطلق نظارتها الجديدة للواقع المعزز التي تعد بثورة في مجال التفاعل بين الإنسان والآلة. النظارة تأتي بدقة عرض عالية وتتبع دقيق للحركة وتكامل سلس مع نظام iOS.",
            image: "https://images.unsplash.com/photo-1678933964986-22090877d8e0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
            date: "10 يونيو 2023"
        },
        {
            title: "ثورة في تخزين البيانات",
            content: "شركة IBM تعلن عن تقنية جديدة لتخزين البيانات باستخدام الذرات الفردية، مما يسمح بتخزين ما يصل إلى 330 تيرابايت من البيانات على شريحة بحجم بطاقة الائتمان. هذه التقنية قد تغير مستقبل مراكز البيانات.",
